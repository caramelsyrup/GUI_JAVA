...
*/	
	...
	public createView() {
		...
		lblNewLabel_1_1.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		lblNewLabel_1_2.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		lblNewLabel_1_3.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		lblNewLabel_1_4.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		lblNewLabel_1_5.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		lblNewLabel_1_6.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					JOptionPane.showMessageDialog(null, "¿Ã¹Ù¸£°Ô ÀÔ·ÂÇÏ¼¼¿ä");
					clearText();
					e.printStackTrace();
				}
			}
		...
		lblSaccount.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 12));
		...
		lblSpwd.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 12));
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				for(member m : arr) {
					taScreen.append("¹øÈ£ : "+m.getNum()+"\n");
					taScreen.append("account : "+m.getAccount()+"\n");
					taScreen.append("password : "+m.getPassword()+"\n");
					taScreen.append("ÀÌ¸§ : "+m.getName()+"\n");
					taScreen.append("»ýÀÏ : "+m.getBirth()+"\n");
					taScreen.append("µµ½Ã : "+m.getCity()+"\n");
					taScreen.append("ÀüÈ­¹øÈ£ : "+m.getPhone()+"\n");
					taScreen.append("ÀÌ¸ÞÀÏ : "+m.getEmail()+"\n");
					taScreen.append("\n");
				}
			}
		});
		btnView.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 15));
		...
		lblSaccount_1.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 12));
